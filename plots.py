...
# ax.fill_between(data[0], data[7][1:,0]+data[8][1:,0], data[7][1:,0]-data[8][1:,0], color="tomato", alpha=0.3)
...
# ax.plot(data[0], data[7][1:,0], color="tomato", marker=".", linestyle="-.", label='LRRL4')
...
# ax2.fill_between(data[0], data[7][1:,2]+data[8][1:,2], data[7][1:,2]-data[8][1:,2], color="cornflowerblue", alpha=0.3)
ax2.plot(data[0], data[1][1:,2], color="blue", marker="o")
ax2.plot(data[0], data[4][1:,2], color="cornflowerblue", marker=".", linestyle="--")
# ax2.plot(data[0], data[7][1:,2], color="cornflowerblue", marker=".", linestyle="--")
...
# plt.plot(data[7][1:,2], data[7][1:,0], color="green", label="LRRL")
...
# print("")
# print("$%.1f \pm %.1f$ & $%.1f \pm %.1f$ & $%.1f \pm %.1f$" % (mean[0], std[0], mean[3], std[3], mean[4], std[4]))
# print("$%.1f \pm %.1f$ & $%.1f \pm %.1f$ & $%.1f \pm %.1f$" % (mean[5], std[5], mean[11], std[11], mean[13], std[13]))
# print("$%.1f \pm %.1f$ & $%.1f \pm %.1f$ & $%.1f \pm %.1f$" % (mean[6], std[6], mean[12], std[12], mean[14], std[14]))
