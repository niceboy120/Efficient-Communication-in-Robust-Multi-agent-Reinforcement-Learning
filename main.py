...
if __name__ == '__main__':
    ...
    while True:
        ...
        try:
            ...
            print(train_agents_regular.gammnet.communication(sequence[0][0], sequence[1][0], 0.0001, print_gamma=True))
            print(train_agents_regular.gammnet.communication(sequence[0][0], sequence[1][0], 0.001, print_gamma=True))
            print(train_agents_regular.gammnet.communication(sequence[0][0], sequence[1][0], 0.01, print_gamma=True))
            print(train_agents_regular.gammnet.communication(sequence[0][0], sequence[1][0], 0.1, print_gamma=True))
            print(train_agents_regular.gammnet.communication(sequence[0][0], sequence[1][0], 1.0, print_gamma=True))
            
            print(train_agents_regular.gammnet.communication(sequence[5][1], sequence[20][1], 0.0001, print_gamma=True))
            print(train_agents_regular.gammnet.communication(sequence[5][1], sequence[20][1], 0.001, print_gamma=True))
            print(train_agents_regular.gammnet.communication(sequence[5][1], sequence[20][1], 0.01, print_gamma=True))
            print(train_agents_regular.gammnet.communication(sequence[5][1], sequence[20][1], 0.1, print_gamma=True))
            print(train_agents_regular.gammnet.communication(sequence[5][1], sequence[20][1], 1.0, print_gamma=True))
